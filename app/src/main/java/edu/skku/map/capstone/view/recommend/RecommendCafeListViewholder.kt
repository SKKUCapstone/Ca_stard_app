...
import edu.skku.map.capstone.view.recommend.minireviewchip.MiniReviewChipListAdapter

class RecommendCafeListViewholder(val context: Context, var binding: ItemCafeFavoriteListBinding):
